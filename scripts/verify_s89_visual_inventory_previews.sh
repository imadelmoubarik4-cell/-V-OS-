...
# replayed database (foundation + recognition privileges + stock count, and
# catalog governance). Each script seeds fixtures inside one transaction,
...
for script in \
  ...
  verify_s89_catalog_governance_preview.sql; do
