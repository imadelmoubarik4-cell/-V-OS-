(function () {
  ...
  function detailMarkup() {
    ...
    return `<section class="stock-count-panel stock-count-detail-panel">
      ...
      <div class="stock-count-controls"><label><i data-lucide="search"></i><input type="search" aria-label="Search stock-count items" data-count-search placeholder="Search item, category, location or barcode" value="${escapeHtml(state.search)}"/></label><select data-line-filter aria-label="Filter stock-count lines"><option value="all" ${state.lineFilter === 'all' ? 'selected' : ''}>All lines</option><option value="pending" ${state.lineFilter === 'pending' ? 'selected' : ''}>Pending</option><option value="counted" ${state.lineFilter === 'counted' ? 'selected' : ''}>Counted</option><option value="skipped" ${state.lineFilter === 'skipped' ? 'selected' : ''}>Skipped</option></select></div>
