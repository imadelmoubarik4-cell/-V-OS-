...
loadAtlasAssetsAfterWindowLoad(() => loadAtlasAssetOnce({
  stylesheetPath: 'assets/css/team-messages.css?v=20260930-s92m',
  scriptPath: 'assets/js/team-messages.js?v=20260930-s92m',
  globalName: 'AtlasTeamMessages',
  dataAttribute: 'atlasTeamMessages',
}));

loadAtlasAssetsAfterWindowLoad(() => loadAtlasAssetOnce({
  scriptPath: 'assets/js/team-unread-badge.js?v=20260930-s92m',
...
loadAtlasAssetsAfterWindowLoad(() => loadAtlasAssetOnce({
  ...
  scriptPath: 'assets/js/team-profile-photos.js?v=20260930-s92m',
