...
const SOURCES = {
  ...
  "purchasing.suggest": "atlas-domain orderSuggestions + orderGroups over projectStock; purchase_orders (user JWT) as ordered input",
...
const EVIDENCE = {
  ...
  "purchasing.suggest": "calculation shortfall/cases; estimate cost; missing no-par/unknown",
  "purchasing.get_supplier": "fact/missing contact details, linked items, open orders",
  "purchasing.prepare_draft_po": "calculation line and order totals; interpretation supplier warnings",
