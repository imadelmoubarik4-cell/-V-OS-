...
export function validateGatewayCase(entry, toolNames) {
  ...
  if (entry.world && !['default', 'hours', 'catalog', 'catalog_vision_off'].includes(entry.world)) errors.push(`${where}: world must be default, hours, catalog or catalog_vision_off`);
