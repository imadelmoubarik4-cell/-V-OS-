...
test('index loads the Atlas AI view root, style and scripts with the S88 cache key', () => {
  ...
  assert.ok(index.indexOf('assets/js/atlas-ai-voice.js?v=20260926-s91b') > index.indexOf('assets/js/atlas-search.js?v=20260929-s90u'));
  assert.ok(index.indexOf('assets/js/atlas-ai.js?v=20260926-s91b') > index.indexOf('assets/js/atlas-ai-voice.js?v=20260926-s91b'));
});
