...
test('index loads the Atlas AI view root, style and scripts with the S88 cache key', () => {
  ...
  assert.match(index, /<link rel="stylesheet" href="assets\/css\/atlas-ai\.css\?v=20261004-bot5">/);
  ...
  assert.ok(index.indexOf('assets/js/atlas-ai.js?v=20261004-bot5') > index.indexOf('assets/js/atlas-ai-voice.js?v=20260926-s91c'));
});
