...
test('Recipes and Business Intelligence delegate to the shared calculation rule (Brain retired in S88)', () => {
  for (const source of [read('apps/web/assets/js/recipes.js'), read('apps/web/assets/js/business.js')]) {
